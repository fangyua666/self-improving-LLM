...
def parse_args(): # set up command line arguments
    ...
    parser.add_argument("--si_iter", type=int, default=1500, help="Iterations per SI round") # change to 500 for string copying
    parser.add_argument("--decay", type=int, default=500, help="Decay steps for scheduler") # change to 0 for string copying
